...
> Official repository: <https://github.com/czppw/emby-migrator>  
> Official Docker image: <https://hub.docker.com/r/czppwa/emby-migrator>  
> License: AGPL-3.0-or-later. Forks and modified versions must preserve copyright notices, license terms, and source attribution.
...
Emby Migrator is distributed under the GNU Affero General Public License v3.0 or later (`AGPL-3.0-or-later`). The canonical upstream project is:

- GitHub: <https://github.com/czppw/emby-migrator>
- Docker Hub: <https://hub.docker.com/r/czppwa/emby-migrator>

Forks, modified versions, redistributed copies, and network-accessible deployments must preserve the `LICENSE`, `NOTICE`, copyright statement, and project source attribution.
